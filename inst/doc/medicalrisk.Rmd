...
**Patrick McCormick**  
[patrick.mccormick@alum.mit.edu](mailto:patrick.mccormick@alum.mit.edu)
...
required for Medicare and Medicaid claims since 1979.  ICD-9-CM is updated annually.

At some point, perhaps as soon as October 2015, ICD-10-CM codes will need to be used instead.
...
"Charlson" refers to the Charlson Comorbidity Index.  The names "Deyo", "Romano", and 
"Quan" refer to the primary authors of different methods of determining Charlson 
comorbidities from ICD-9-CM codes.

"Elixhauser" refers to the Elixhauser comorbidities, which is a more detailed list than 
Charlson.  "AHRQ37" is an adapation of the AHRQ version 37 software.  "Quan" refers
to the same paper by Quan mentioned above.

"RCRI" is the Revised Cardiac Risk Index set of categories using a method published by
Boersma.
